...
public class LoginController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // ... (código existente para obtener docIdentidad, pass, y validar)
        ...
        if (usuario.getEstadoValidacion() == UsuarioDAO.EstadoValidacion.LOGIN_EXITOSO) {
            ...
            // =================================================================
            // ==           CAMBIO: Redirección basada en ROL               ==
            // =================================================================
            String rol = usuario.getRol().getNombreRol();
            if ("Paciente".equals(rol)) {
                // Si es Paciente, va al nuevo dashboard de paciente
                response.sendRedirect("paciente-dashboard/dashboard.jsp?login=success");
            } else {
                // Si es Admin, Odontólogo, etc., va al dashboard de admin
                response.sendRedirect("dashboard/dashboard.jsp?login=success");
            }
            // =================================================================

        } else {
            // ... (Tu código de manejo de error no cambia)
            String mensajeError = "";
